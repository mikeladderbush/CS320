...
public class DatabaseStatement {
                ...
                try (PreparedStatement statement = conn.prepareStatement(sqlStatement,
                    ...
                    try (ResultSet generatedKeys = statement.getGeneratedKeys()) {
                        if (generatedKeys.next()) {
                            ...
                            user.setId(String.valueOf(userId)); // Set the generated ID
    ...
    private static void insertEmployee(Connection conn, Employee employee, int userId) throws SQLException {
    ...
    private static void insertAdministrator(Connection conn, Administrator administrator, int userId)
            throws SQLException {
